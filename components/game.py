...
class Game:
    ...
    def show_start_screen(self):
        ...
        draw_text(self.screen, "EPIC GAMER WAR", 64, SCREEN_WIDTH/2,SCREEN_HEIGHT/4)
        draw_text(self.screen,
                "Press the arrows to move and Press Space to shoot",
                20,
                SCREEN_WIDTH/2, SCREEN_HEIGHT/2)
        draw_text(self.screen,"Press ENTER key to begin",
                20,
                SCREEN_WIDTH/2,
                SCREEN_HEIGHT*3/5)
        pygame.display.flip()
